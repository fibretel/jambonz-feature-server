...
const {redactFsInventory} = require('./redact');
...
function installSrfLocals(srf, logger, {
  ...
  (async function() {
    ...
    /* NEVER log fsInventory raw: entry.secret is the freeswitch event-socket
       password, i.e. a root-equivalent control channel, and this line runs on
       every boot. See lib/utils/redact.js. */
    logger.info({fsInventory: redactFsInventory(fsInventory)}, 'freeswitch inventory');
