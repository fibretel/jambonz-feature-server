...
/* how long an openai s2s session waits for the server's session.updated ack before
   sending response.create without confirmation -- a silent server must not wedge a call */
const JAMBONES_S2S_SESSION_UPDATED_TIMEOUT_MS =
  parseInt(process.env.JAMBONES_S2S_SESSION_UPDATED_TIMEOUT_MS, 10) || 2000;
...
module.exports = {
  ...
  JAMBONES_S2S_SESSION_UPDATED_TIMEOUT_MS,
